...
* [`src/cljs/tom/`](src/cljs/tom/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/tom/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/tom/`](test/cljs/tom/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `tom` project root directory
